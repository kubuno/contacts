...
#   /usr/lib/kubuno/modules/contacts/{kubuno-contacts, module.toml, frontend/}
#   /usr/share/kubuno/modules/contacts/migrations/*.sql
#   /etc/kubuno/modules/contacts/config.toml.example
#
# Usage :
